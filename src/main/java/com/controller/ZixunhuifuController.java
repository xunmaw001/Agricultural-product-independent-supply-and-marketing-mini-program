...
public class ZixunhuifuController {
    ...
    public R page(@RequestParam Map<String, Object> params,ZixunhuifuEntity zixunhuifu, 
		...
		if(tableName.equals("nonghu")) {
			zixunhuifu.setNonghuzhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yonghu")) {
			zixunhuifu.setYonghuzhanghao((String)request.getSession().getAttribute("username"));
		}
